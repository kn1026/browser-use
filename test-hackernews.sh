...
echo "========================================"
echo "🧪 Hacker News Top 5 Test (via Proxy)"
echo "========================================"
echo ""
...
echo ""
echo "========================================"
echo "🚀 Getting top 5 Hacker News stories..."
echo "========================================"
echo ""
...
cat > /tmp/test-hackernews.py << 'PYTHON_SCRIPT'
import asyncio
import os
import sys
...
async def main():
    ...
    # Simple Hacker News task
    task = """Go to news.ycombinator.com (Hacker News) and extract the titles of the top 5 stories on the front page.
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    echo "✅ Got Hacker News stories via SnowX API proxy!"
else
